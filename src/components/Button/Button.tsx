...
const Button: React.FC<IProps> = ({ onClick, title, variant, type }) => {
  const variantObj = {
    ...
    outlined:
      "middle none center rounded-lg border border-pink-500 py-3 px-6 font-sans text-xs font-bold uppercase text-pink-500 transition-all hover:opacity-75 focus:ring focus:ring-pink-200 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none",
  };
